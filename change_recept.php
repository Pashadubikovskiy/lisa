...
<!--                <span class="drop-zone__prompt">додати фото</span>-->
            ...
            <ul class="change-recept__links">
                ...
                <li class="change-recept__link change-recept-link">
                    <a href="#" class="change-recept-link__label change-recept-link__label--plus">
                        додати нову заміну
                    </a>
                </li>
            </ul>
        ...
        <div class="change-recept__table change-recept-table">
            <div class="change-recept-table__body">
                <div class="change-recept-table__row">
                    ...
                    <div class="change-recept-table__col change-recept-table__col--2"><img src="img/img-material.jpg" alt="Ранункулюс болотний" class="change-recept-table__img open-image"></div>
                    <div class="change-recept-table__col change-recept-table__col--3">ранункулюс болотний</div>
